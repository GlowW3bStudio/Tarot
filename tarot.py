    ...
    try:
        with conn.cursor() as c:
            ...
            for u in users:
                ...
                try:
                    if has_photo:
                        sent_msg = await context.bot.send_photo(chat_id=user_id, photo=file_id, caption=content_text)
                    else:
                        sent_msg = await context.bot.send_message(chat_id=user_id, text=content_text)
