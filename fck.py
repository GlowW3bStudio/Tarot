...
# ၇။ App ထဲသို့ Handlers အားလုံး ထည့်သွင်းခြင်း (tarot.py ၏ Logic ကို အသုံးပြုထားသည်)
    
    # --- ပထမဦးစားပေး: Global Commands (ဘယ်အချိန်မဆို အလုပ်လုပ်ရန်) ---
    app.add_handler(CommandHandler("help", admin_help)) # /help ကို အပေါ်ဆုံးတင်လိုက်ပါ
    app.add_handler(CommandHandler("start", start))
    app.add_handler(CommandHandler("admin", admin_panel))

    # --- ဒုတိယဦးစားပေး: Conversation Handlers ---
    conv_handler = ConversationHandler(
        entry_points=[
            MessageHandler(filters.Regex("^🔮 Tarot မေးမည်$"), tarot_init),
            MessageHandler(filters.Regex("^✍️ အကြံပြုစာပို့ရန်$"), handle_suggestion),
        ...
        allow_reentry=True,
        per_message=False # tarot.py အတိုင်း False ထားပါသည်
    )
    ...
    # --- တတိယဦးစားပေး: အခြား Message & Admin Handlers ---
